...
const UpcomingRuns: React.FC<RunsProps> = ({ 
  ...
  // Show all runs without limiting them
  const upcomingRuns = upcomingRunsData
            ...
            {upcomingRuns.map((run, index) => (
              ...
              >
                <div className="flex justify-between items-start">
                  <div>
                    <p className="font-semibold text-base md:text-lg text-slate-800 dark:text-slate-200">{run.displayDate.replace('Apr', 'April')}</p>
